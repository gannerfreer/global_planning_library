...
(cl:defclass <Waypoint> (roslisp-msg-protocol:ros-message)
  ((gid
   ...
   (dtlane
    :reader dtlane
    :initarg :dtlane
    :type msg_lidar_shape-msg:DTLane
    :initform (cl:make-instance 'msg_lidar_shape-msg:DTLane))
   (change_flag
    :reader change_flag
    :initarg :change_flag
    :type cl:integer
   ...
   (wpstate
    :reader wpstate
    :initarg :wpstate
    :type msg_lidar_shape-msg:WaypointState
    :initform (cl:make-instance 'msg_lidar_shape-msg:WaypointState))
   (lane_id
    :reader lane_id
    :initarg :lane_id
    :type cl:integer
...
(cl:defmethod cl:initialize-instance :after ((m <Waypoint>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Waypoint)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name msg_lidar_shape-msg:<Waypoint> is deprecated: use msg_lidar_shape-msg:Waypoint instead.")))

(cl:ensure-generic-function 'gid-val :lambda-list '(m))
(cl:defmethod gid-val ((m <Waypoint>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader msg_lidar_shape-msg:gid-val is deprecated.  Use msg_lidar_shape-msg:gid instead.")
  (gid m))

(cl:ensure-generic-function 'lid-val :lambda-list '(m))
(cl:defmethod lid-val ((m <Waypoint>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader msg_lidar_shape-msg:lid-val is deprecated.  Use msg_lidar_shape-msg:lid instead.")
  (lid m))
...
(cl:defmethod twist-val ((m <Waypoint>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader msg_lidar_shape-msg:twist-val is deprecated.  Use msg_lidar_shape-msg:twist instead.")
  (twist m))

(cl:ensure-generic-function 'dtlane-val :lambda-list '(m))
(cl:defmethod dtlane-val ((m <Waypoint>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader msg_lidar_shape-msg:dtlane-val is deprecated.  Use msg_lidar_shape-msg:dtlane instead.")
  (dtlane m))

(cl:ensure-generic-function 'change_flag-val :lambda-list '(m))
(cl:defmethod change_flag-val ((m <Waypoint>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader msg_lidar_shape-msg:change_flag-val is deprecated.  Use msg_lidar_shape-msg:change_flag instead.")
  (change_flag m))

(cl:ensure-generic-function 'wpstate-val :lambda-list '(m))
(cl:defmethod wpstate-val ((m <Waypoint>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader msg_lidar_shape-msg:wpstate-val is deprecated.  Use msg_lidar_shape-msg:wpstate instead.")
  (wpstate m))

(cl:ensure-generic-function 'lane_id-val :lambda-list '(m))
(cl:defmethod lane_id-val ((m <Waypoint>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader msg_lidar_shape-msg:lane_id-val is deprecated.  Use msg_lidar_shape-msg:lane_id instead.")
  (lane_id m))

(cl:ensure-generic-function 'left_lane_id-val :lambda-list '(m))
(cl:defmethod left_lane_id-val ((m <Waypoint>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader msg_lidar_shape-msg:left_lane_id-val is deprecated.  Use msg_lidar_shape-msg:left_lane_id instead.")
  (left_lane_id m))

(cl:ensure-generic-function 'right_lane_id-val :lambda-list '(m))
(cl:defmethod right_lane_id-val ((m <Waypoint>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader msg_lidar_shape-msg:right_lane_id-val is deprecated.  Use msg_lidar_shape-msg:right_lane_id instead.")
  (right_lane_id m))

(cl:ensure-generic-function 'stop_line_id-val :lambda-list '(m))
(cl:defmethod stop_line_id-val ((m <Waypoint>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader msg_lidar_shape-msg:stop_line_id-val is deprecated.  Use msg_lidar_shape-msg:stop_line_id instead.")
  (stop_line_id m))

(cl:ensure-generic-function 'cost-val :lambda-list '(m))
(cl:defmethod cost-val ((m <Waypoint>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader msg_lidar_shape-msg:cost-val is deprecated.  Use msg_lidar_shape-msg:cost instead.")
  (cost m))

(cl:ensure-generic-function 'time_cost-val :lambda-list '(m))
(cl:defmethod time_cost-val ((m <Waypoint>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader msg_lidar_shape-msg:time_cost-val is deprecated.  Use msg_lidar_shape-msg:time_cost instead.")
  (time_cost m))

(cl:ensure-generic-function 'direction-val :lambda-list '(m))
(cl:defmethod direction-val ((m <Waypoint>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader msg_lidar_shape-msg:direction-val is deprecated.  Use msg_lidar_shape-msg:direction instead.")
  (direction m))
