...
(cl:defclass <LaneArray> (roslisp-msg-protocol:ros-message)
  ((id
   ...
   (lanes
    :reader lanes
    :initarg :lanes
    :type (cl:vector msg_lidar_shape-msg:Lane)
   :initform (cl:make-array 0 :element-type 'msg_lidar_shape-msg:Lane :initial-element (cl:make-instance 'msg_lidar_shape-msg:Lane))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <LaneArray>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'LaneArray)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name msg_lidar_shape-msg:<LaneArray> is deprecated: use msg_lidar_shape-msg:LaneArray instead.")))
...
(cl:defmethod lanes-val ((m <LaneArray>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader msg_lidar_shape-msg:lanes-val is deprecated.  Use msg_lidar_shape-msg:lanes instead.")
  (lanes m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <LaneArray>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'lanes)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'msg_lidar_shape-msg:Lane))
