...
class msg_local_planning {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new msg_local_planning(null);
  ...
  static messageDefinition() {
    ...
    return `
    uint16  target_id  		#任务指令编号 0自检  1启动发动机  2静态测试 .....
    uint32 traj_id
  ...
  static Resolve(msg) {
    ...
    const resolved = new msg_local_planning(null);
...
module.exports = msg_local_planning;
