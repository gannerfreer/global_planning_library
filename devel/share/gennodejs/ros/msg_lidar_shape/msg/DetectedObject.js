...
// (in-package msg_lidar_shape.msg)
...
class DetectedObject {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      this.x = null;
      this.y = null;
      this.x_bottom_left = null;
      this.y_bottom_left = null;
      this.x_bottom_cent = null;
      this.y_bottom_cent = null;
      this.x_bottom_right = null;
      this.y_bottom_right = null;
      this.width = null;
      this.height = null;
      this.angle = null;
      this.roi_image = null;
      ...
      if (initObj.hasOwnProperty('x_bottom_left')) {
        this.x_bottom_left = initObj.x_bottom_left
      }
      else {
        this.x_bottom_left = 0.0;
      }
      if (initObj.hasOwnProperty('y_bottom_left')) {
        this.y_bottom_left = initObj.y_bottom_left
      }
      else {
        this.y_bottom_left = 0.0;
      }
      if (initObj.hasOwnProperty('x_bottom_cent')) {
        this.x_bottom_cent = initObj.x_bottom_cent
      }
      else {
        this.x_bottom_cent = 0.0;
      }
      if (initObj.hasOwnProperty('y_bottom_cent')) {
        this.y_bottom_cent = initObj.y_bottom_cent
      }
      else {
        this.y_bottom_cent = 0.0;
      }
      if (initObj.hasOwnProperty('x_bottom_right')) {
        this.x_bottom_right = initObj.x_bottom_right
      }
      else {
        this.x_bottom_right = 0.0;
      }
      if (initObj.hasOwnProperty('y_bottom_right')) {
        this.y_bottom_right = initObj.y_bottom_right
      }
      else {
        this.y_bottom_right = 0.0;
      }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    // Serialize message field [x_bottom_left]
    bufferOffset = _serializer.float32(obj.x_bottom_left, buffer, bufferOffset);
    // Serialize message field [y_bottom_left]
    bufferOffset = _serializer.float32(obj.y_bottom_left, buffer, bufferOffset);
    // Serialize message field [x_bottom_cent]
    bufferOffset = _serializer.float32(obj.x_bottom_cent, buffer, bufferOffset);
    // Serialize message field [y_bottom_cent]
    bufferOffset = _serializer.float32(obj.y_bottom_cent, buffer, bufferOffset);
    // Serialize message field [x_bottom_right]
    bufferOffset = _serializer.float32(obj.x_bottom_right, buffer, bufferOffset);
    // Serialize message field [y_bottom_right]
    bufferOffset = _serializer.float32(obj.y_bottom_right, buffer, bufferOffset);
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    // Deserialize message field [x_bottom_left]
    data.x_bottom_left = _deserializer.float32(buffer, bufferOffset);
    // Deserialize message field [y_bottom_left]
    data.y_bottom_left = _deserializer.float32(buffer, bufferOffset);
    // Deserialize message field [x_bottom_cent]
    data.x_bottom_cent = _deserializer.float32(buffer, bufferOffset);
    // Deserialize message field [y_bottom_cent]
    data.y_bottom_cent = _deserializer.float32(buffer, bufferOffset);
    // Deserialize message field [x_bottom_right]
    data.x_bottom_right = _deserializer.float32(buffer, bufferOffset);
    // Deserialize message field [y_bottom_right]
    data.y_bottom_right = _deserializer.float32(buffer, bufferOffset);
  ...
  static datatype() {
    ...
    return 'msg_lidar_shape/DetectedObject';
  }

  static md5sum() {
    //Returns md5sum for a message object
    return 'a19fc5a445e31415d21a8b2ab0271a76';
  }
  ...
  static messageDefinition() {
    ...
    float32 z
    ================================================================================
    MSG: msg_lidar_shape/LaneArray
    int32 id
    Lane[] lanes
    
    ================================================================================
    MSG: msg_lidar_shape/Lane
    Header header
    int32 increment
    int32 lane_id
    Waypoint[] waypoints
    ...
    ================================================================================
    MSG: msg_lidar_shape/WaypointState
    int32 aid
    uint8 NULLSTATE=0
  ...
  static Resolve(msg) {
    ...
    if (msg.x_bottom_left !== undefined) {
      resolved.x_bottom_left = msg.x_bottom_left;
    }
    else {
      resolved.x_bottom_left = 0.0
    }

    if (msg.y_bottom_left !== undefined) {
      resolved.y_bottom_left = msg.y_bottom_left;
    }
    else {
      resolved.y_bottom_left = 0.0
    }

    if (msg.x_bottom_cent !== undefined) {
      resolved.x_bottom_cent = msg.x_bottom_cent;
    }
    else {
      resolved.x_bottom_cent = 0.0
    }

    if (msg.y_bottom_cent !== undefined) {
      resolved.y_bottom_cent = msg.y_bottom_cent;
    }
    else {
      resolved.y_bottom_cent = 0.0
    }

    if (msg.x_bottom_right !== undefined) {
      resolved.x_bottom_right = msg.x_bottom_right;
    }
    else {
      resolved.x_bottom_right = 0.0
    }

    if (msg.y_bottom_right !== undefined) {
      resolved.y_bottom_right = msg.y_bottom_right;
    }
    else {
      resolved.y_bottom_right = 0.0
    }
