...
"""autogenerated by genpy from msg_lidar_shape/DetectedObjectArray.msg. Do not edit."""
import codecs
import sys
...
class DetectedObjectArray(genpy.Message):
  _md5sum = "f9d4061d17eed09cb4fa36a8ccd55a0e"
  _type = "msg_lidar_shape/DetectedObjectArray"
...
"""
  ...
  _slot_types = ['std_msgs/Header','msg_lidar_shape/DetectedObject[]']
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      for val1 in self.objects:
        ...
        _x = val1
        buff.write(_get_struct_2B().pack(_x.valid, _x.absolute_motion))
        _x = val1.space_frame
        length = len(_x)
        if python3 or type(_x) == unicode:
          _x = _x.encode('utf-8')
        ...
        _v31 = val1.candidate_trajectories
        _x = _v31.id
        buff.write(_get_struct_i().pack(_x))
        length = len(_v31.lanes)
        buff.write(_struct_I.pack(length))
        for val3 in _v31.lanes:
          _v32 = val3.header
          _x = _v32.seq
          buff.write(_get_struct_I().pack(_x))
          _v33 = _v32.stamp
        ...
        buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
        _x = val1
        buff.write(_get_struct_11f().pack(_x.x, _x.y, _x.x_bottom_left, _x.y_bottom_left, _x.x_bottom_cent, _x.y_bottom_cent, _x.x_bottom_right, _x.y_bottom_right, _x.width, _x.height, _x.angle))
        _v48 = val1.roi_image
        _v49 = _v48.header
        _x = _v49.seq
        buff.write(_get_struct_I().pack(_x))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = msg_lidar_shape.msg.DetectedObject()
        _v51 = val1.header
        start = end
        end += 4
        ...
        (_x.valid, _x.absolute_motion,) = _get_struct_2B().unpack(str[start:end])
        ...
        if python3:
          _v68.ns = str[start:end].decode('utf-8', 'rosmsg')
        else:
          _v68.ns = str[start:end]
        _x = _v68
        start = end
        end += 12
        ...
        (_v68.frame_locked,) = _get_struct_B().unpack(str[start:end])
        _v68.frame_locked = bool(_v68.frame_locked)
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        _v68.points = []
        ...
        if python3:
          _v68.text = str[start:end].decode('utf-8', 'rosmsg')
        else:
          _v68.text = str[start:end]
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        start = end
        ...
        if python3:
          _v68.mesh_resource = str[start:end].decode('utf-8', 'rosmsg')
        else:
          _v68.mesh_resource = str[start:end]
        start = end
        end += 1
        (_v68.mesh_use_embedded_materials,) = _get_struct_B().unpack(str[start:end])
        _v68.mesh_use_embedded_materials = bool(_v68.mesh_use_embedded_materials)
        ...
        _v81 = val1.candidate_trajectories
        start = end
        end += 4
        (_v81.id,) = _get_struct_i().unpack(str[start:end])
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        _v81.lanes = []
        for i in range(0, length):
          val3 = msg_lidar_shape.msg.Lane()
          _v82 = val3.header
          start = end
          end += 4
          ...
          val3.waypoints = []
          for i in range(0, length):
            val4 = msg_lidar_shape.msg.Waypoint()
            _x = val4
            start = end
            end += 8
        ...
        (_x.x, _x.y, _x.x_bottom_left, _x.y_bottom_left, _x.x_bottom_cent, _x.y_bottom_cent, _x.x_bottom_right, _x.y_bottom_right, _x.width, _x.height, _x.angle,) = _get_struct_11f().unpack(str[start:end])
        _v98 = val1.roi_image
        _v99 = _v98.header
        start = end
        end += 4
  ...
  def serialize_numpy(self, buff, numpy):
    ...
    try:
      ...
      for val1 in self.objects:
        ...
        _x = _v125
        buff.write(_get_struct_4f().pack(_x.r, _x.g, _x.b, _x.a))
        _v126 = _v118.lifetime
        _x = _v126
        buff.write(_get_struct_2i().pack(_x.secs, _x.nsecs))
        _x = _v118.frame_locked
        buff.write(_get_struct_B().pack(_x))
        ...
        for val3 in _v118.points:
          _x = val3
          buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.z))
        length = len(_v118.colors)
        buff.write(_struct_I.pack(length))
        for val3 in _v118.colors:
          _x = val3
          buff.write(_get_struct_4f().pack(_x.r, _x.g, _x.b, _x.a))
        _x = _v118.text
        length = len(_x)
        if python3 or type(_x) == unicode:
          ...
          length = len(_x)
        buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
        _x = _v118.mesh_resource
        length = len(_x)
        if python3 or type(_x) == unicode:
          _x = _x.encode('utf-8')
          length = len(_x)
        buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
        _x = _v118.mesh_use_embedded_materials
        buff.write(_get_struct_B().pack(_x))
        _v127 = val1.convex_hull
        _v128 = _v127.header
        _x = _v128.seq
        buff.write(_get_struct_I().pack(_x))
        _v129 = _v128.stamp
        ...
        for val4 in _v130.points:
          _x = val4
          buff.write(_get_struct_3f().pack(_x.x, _x.y, _x.z))
        _v131 = val1.candidate_trajectories
        _x = _v131.id
        buff.write(_get_struct_i().pack(_x))
        length = len(_v131.lanes)
        buff.write(_struct_I.pack(length))
        for val3 in _v131.lanes:
          _v132 = val3.header
          _x = _v132.seq
          buff.write(_get_struct_I().pack(_x))
          _v133 = _v132.stamp
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        if python3:
          _v168.ns = str[start:end].decode('utf-8', 'rosmsg')
        else:
          _v168.ns = str[start:end]
        _x = _v168
        start = end
        end += 12
        (_x.id, _x.type, _x.action,) = _get_struct_3i().unpack(str[start:end])
        ...
        (_v168.frame_locked,) = _get_struct_B().unpack(str[start:end])
        _v168.frame_locked = bool(_v168.frame_locked)
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        _v168.points = []
        ...
        if python3:
          _v168.text = str[start:end].decode('utf-8', 'rosmsg')
        else:
          _v168.text = str[start:end]
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        start = end
        ...
        if python3:
          _v168.mesh_resource = str[start:end].decode('utf-8', 'rosmsg')
        else:
          _v168.mesh_resource = str[start:end]
        start = end
        end += 1
        (_v168.mesh_use_embedded_materials,) = _get_struct_B().unpack(str[start:end])
        _v168.mesh_use_embedded_materials = bool(_v168.mesh_use_embedded_materials)
        _v177 = val1.convex_hull
        _v178 = _v177.header
        start = end
        end += 4
        ...
        for i in range(0, length):
          ...
          (_x.x, _x.y, _x.z,) = _get_struct_3f().unpack(str[start:end])
          _v180.points.append(val4)
        _v181 = val1.candidate_trajectories
        start = end
        end += 4
        (_v181.id,) = _get_struct_i().unpack(str[start:end])
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        _v181.lanes = []
        ...
        if python3:
          _v198.encoding = str[start:end].decode('utf-8', 'rosmsg')
        else:
          _v198.encoding = str[start:end]
        _x = _v198
        start = end
        end += 5
        (_x.is_bigendian, _x.step,) = _get_struct_BI().unpack(str[start:end])
