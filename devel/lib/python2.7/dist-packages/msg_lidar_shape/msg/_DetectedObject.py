...
"""autogenerated by genpy from msg_lidar_shape/DetectedObject.msg. Do not edit."""
import codecs
import sys
...
import msg_lidar_shape.msg
import sensor_msgs.msg
import std_msgs.msg
import visualization_msgs.msg

class DetectedObject(genpy.Message):
  _md5sum = "a19fc5a445e31415d21a8b2ab0271a76"
  _type = "msg_lidar_shape/DetectedObject"
...
"""
  __slots__ = ['header','id','label','score','color','valid','absolute_motion','space_frame','pose','dimensions','variance','velocity','acceleration','pointcloud','line_list','convex_hull','candidate_trajectories','pose_reliable','velocity_reliable','acceleration_reliable','image_frame','x','y','x_bottom_left','y_bottom_left','x_bottom_cent','y_bottom_cent','x_bottom_right','y_bottom_right','width','height','angle','roi_image','indicator_state','behavior_state','user_defined_info']
  _slot_types = ['std_msgs/Header','uint32','string','float32','std_msgs/ColorRGBA','bool','uint8','string','geometry_msgs/Pose','geometry_msgs/Vector3','geometry_msgs/Vector3','geometry_msgs/Twist','geometry_msgs/Twist','sensor_msgs/PointCloud2','visualization_msgs/Marker','geometry_msgs/PolygonStamped','msg_lidar_shape/LaneArray','bool','bool','bool','string','float32','float32','float32','float32','float32','float32','float32','float32','float32','float32','float32','sensor_msgs/Image','uint8','uint8','string[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,id,label,score,color,valid,absolute_motion,space_frame,pose,dimensions,variance,velocity,acceleration,pointcloud,line_list,convex_hull,candidate_trajectories,pose_reliable,velocity_reliable,acceleration_reliable,image_frame,x,y,x_bottom_left,y_bottom_left,x_bottom_cent,y_bottom_cent,x_bottom_right,y_bottom_right,width,height,angle,roi_image,indicator_state,behavior_state,user_defined_info
    ...
    if args or kwds:
      ...
      if self.candidate_trajectories is None:
        self.candidate_trajectories = msg_lidar_shape.msg.LaneArray()
      ...
      if self.y is None:
        self.y = 0.
      if self.x_bottom_left is None:
        self.x_bottom_left = 0.
      if self.y_bottom_left is None:
        self.y_bottom_left = 0.
      if self.x_bottom_cent is None:
        self.x_bottom_cent = 0.
      if self.y_bottom_cent is None:
        self.y_bottom_cent = 0.
      if self.x_bottom_right is None:
        self.x_bottom_right = 0.
      if self.y_bottom_right is None:
        self.y_bottom_right = 0.
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_5f2B().pack(_x.score, _x.color.r, _x.color.g, _x.color.b, _x.color.a, _x.valid, _x.absolute_motion))
      _x = self.space_frame
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
      ...
      if type(_x) in [list, tuple]:
        ...
        buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_B3I().pack(_x.pointcloud.is_dense, _x.line_list.header.seq, _x.line_list.header.stamp.secs, _x.line_list.header.stamp.nsecs))
      ...
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_B3I().pack(_x.line_list.mesh_use_embedded_materials, _x.convex_hull.header.seq, _x.convex_hull.header.stamp.secs, _x.convex_hull.header.stamp.nsecs))
      ...
      _x = self.candidate_trajectories.id
      buff.write(_get_struct_i().pack(_x))
      ...
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_11f3I().pack(_x.x, _x.y, _x.x_bottom_left, _x.y_bottom_left, _x.x_bottom_cent, _x.y_bottom_cent, _x.x_bottom_right, _x.y_bottom_right, _x.width, _x.height, _x.angle, _x.roi_image.header.seq, _x.roi_image.header.stamp.secs, _x.roi_image.header.stamp.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.score, _x.color.r, _x.color.g, _x.color.b, _x.color.a, _x.valid, _x.absolute_motion,) = _get_struct_5f2B().unpack(str[start:end])
      ...
      (_x.pointcloud.is_dense, _x.line_list.header.seq, _x.line_list.header.stamp.secs, _x.line_list.header.stamp.nsecs,) = _get_struct_B3I().unpack(str[start:end])
      ...
      (_x.line_list.mesh_use_embedded_materials, _x.convex_hull.header.seq, _x.convex_hull.header.stamp.secs, _x.convex_hull.header.stamp.nsecs,) = _get_struct_B3I().unpack(str[start:end])
      ...
      for i in range(0, length):
        ...
        val1.waypoints = []
        for i in range(0, length):
          val2 = msg_lidar_shape.msg.Waypoint()
          _x = val2
          start = end
          end += 8
      ...
      (_x.x, _x.y, _x.x_bottom_left, _x.y_bottom_left, _x.x_bottom_cent, _x.y_bottom_cent, _x.x_bottom_right, _x.y_bottom_right, _x.width, _x.height, _x.angle, _x.roi_image.header.seq, _x.roi_image.header.stamp.secs, _x.roi_image.header.stamp.nsecs,) = _get_struct_11f3I().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
...
def _get_struct_I():
    ...
    return _struct_I
_struct_11f3I = None
def _get_struct_11f3I():
    global _struct_11f3I
    if _struct_11f3I is None:
        _struct_11f3I = struct.Struct("<11f3I")
    return _struct_11f3I
_struct_25d3I = None
