...
"""autogenerated by genpy from msg_lidar_shape/Waypoint.msg. Do not edit."""
import codecs
import sys
...
class Waypoint(genpy.Message):
  ...
  _type = "msg_lidar_shape/Waypoint"
...
"""
  ...
  _slot_types = ['int32','int32','geometry_msgs/PoseStamped','geometry_msgs/TwistStamped','msg_lidar_shape/DTLane','int32','msg_lidar_shape/WaypointState','uint32','uint32','uint32','uint32','float32','float32','uint32']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.dtlane is None:
        self.dtlane = msg_lidar_shape.msg.DTLane()
      if self.change_flag is None:
        self.change_flag = 0
      if self.wpstate is None:
        self.wpstate = msg_lidar_shape.msg.WaypointState()
