...
"""autogenerated by genpy from msg_lidar_shape/Lane.msg. Do not edit."""
import codecs
import sys
...
"""
  ...
  _slot_types = ['std_msgs/Header','int32','int32','msg_lidar_shape/Waypoint[]','uint32','float32','float32','float32','bool']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = msg_lidar_shape.msg.Waypoint()
        _x = val1
        start = end
        end += 8
