// Generated by gencpp from file msg_lidar_shape/WaypointState.msg
// DO NOT EDIT!


#ifndef MSG_LIDAR_SHAPE_MESSAGE_WAYPOINTSTATE_H
#define MSG_LIDAR_SHAPE_MESSAGE_WAYPOINTSTATE_H
...
// reducing the odds to have name collisions with Windows.h 
  ...
  typedef boost::shared_ptr< ::msg_lidar_shape::WaypointState_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::msg_lidar_shape::WaypointState_<ContainerAllocator> const> ConstPtr;

}; // struct WaypointState_

typedef ::msg_lidar_shape::WaypointState_<std::allocator<void> > WaypointState;

typedef boost::shared_ptr< ::msg_lidar_shape::WaypointState > WaypointStatePtr;
typedef boost::shared_ptr< ::msg_lidar_shape::WaypointState const> WaypointStateConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::msg_lidar_shape::WaypointState_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::msg_lidar_shape::WaypointState_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::msg_lidar_shape::WaypointState_<ContainerAllocator1> & lhs, const ::msg_lidar_shape::WaypointState_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsFixedSize< ::msg_lidar_shape::WaypointState_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::msg_lidar_shape::WaypointState_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::msg_lidar_shape::WaypointState_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::msg_lidar_shape::WaypointState_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::msg_lidar_shape::WaypointState_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::msg_lidar_shape::WaypointState_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::msg_lidar_shape::WaypointState_<ContainerAllocator> >
{
  ...
  static const char* value(const ::msg_lidar_shape::WaypointState_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x623a0ffbb0a05249ULL;
  static const uint64_t static_value2 = 0x0adc981c2a3e8eddULL;
};

template<class ContainerAllocator>
struct DataType< ::msg_lidar_shape::WaypointState_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::msg_lidar_shape::WaypointState_<ContainerAllocator> >
{
  static const char* value()
  {
    return "int32 aid\n"
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::msg_lidar_shape::WaypointState_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::msg_lidar_shape::WaypointState_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::msg_lidar_shape::WaypointState_<ContainerAllocator>& v)
  {
    s << indent << "aid: ";
...
#endif // MSG_LIDAR_SHAPE_MESSAGE_WAYPOINTSTATE_H
