...
bool GetMap(char* parea) {
    cout << "GlobalPathPlanning-IDS_Global_Planning_version: G_V1.0.1.20240802_RC" << endl;
    cout << "规划库版本号:G_V1.0.1.20240802_RC" << endl;
...
char* GlobalPathPlanning(char* point_veh_start_end) {
    ...
    planning.threadLogger_->info("GlobalPathPlanning-IDS_Global_Planning_version: G_V1.0.1.20240802_RC");
