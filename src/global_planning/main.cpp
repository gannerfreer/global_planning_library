...
void StartPositionCallback(const geometry_msgs::PoseWithCovarianceStamped::ConstPtr& msg) {
    ...
    start_point.x   = -678.435 - x_o_;
    start_point.y   = 1139.357 - y_o_;
    start_point.yaw = 356.7330017089844 / 180.0 * M_PI;
...
void EndPositionCallback(const geometry_msgs::PoseStamped::ConstPtr& msg) {
    ...
    end_point.x   = -494.3424585365 - x_o_;
    end_point.y   = 881.9761420782 - y_o_;
    end_point.yaw = 285.6421439481 / 180.0 * M_PI;
