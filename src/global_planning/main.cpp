...
Single_Point start_point;
Single_Point end_point;
bool is_receive_start = false;
bool is_receive_end = false;

// const float64 x_o_ = -1171.654151; // 玖智偏移参数
// const float64 y_o_ = 6205.765819;  // 玖智偏移参数

// const float64 x_o_ = -321737.4857;     // 舒兰偏移参数
// const float64 y_o_ = 534463.584699999; // 舒兰偏移参数

const float64 x_o_ = 0; // 鲁南偏移参数
const float64 y_o_ = 0; // 鲁南偏移参数

// const float64 x_o_ = -205293.9231; // 致富偏移参数
// const float64 y_o_ = 7973.5012;    // 致富偏移参数
...
cout<<"line171"<<endl;
            ...
            for (size_t i = 0; i < global_path.size(); i++)
            {
                ...
                file_out << std::setprecision(11)
                         ...
                         << static_cast<int>(global_path.at(i).attribute) << " "
                         << global_path.at(i).distance << std::endl;
            }
            file_out.close();
cout<<"line202"<<endl;
