...
const double x_o_ = -434;  // 园区偏移参数
const double y_o_ = -1037; // 园区偏移参数
...
void StartPositionCallback(const geometry_msgs::PoseWithCovarianceStamped::ConstPtr& msg) {
    ...
    start_point.x   = -1076.6183471679688 - x_o_;
    start_point.y   = -186.14495849609375 - y_o_;
    start_point.yaw = 33.19222634721492 / 180.0 * M_PI;
...
void EndPositionCallback(const geometry_msgs::PoseStamped::ConstPtr& msg) {
    ...
    end_point.x   = -1091.4560546875 - x_o_;
    end_point.y   = -176.233642578125 - y_o_;
    end_point.yaw = 268.2825942400463 / 180.0 * M_PI;
