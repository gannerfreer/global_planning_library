...
void spline::set_points(const std::vector<double>& x, const std::vector<double>& y, bool cubic_spline) {
    ...
    if (cubic_spline == true) { // cubic spline interpolation
        ...
        if (m_left == spline::second_deriv) {
            // std::cout << "m_left == spline::second_deriv" << std::endl;
            // std::cout << "m_leff_value:" << m_left_value << std::endl;
            // 2*b[0] = f''
            A(0, 0) = 2.0;
            A(0, 1) = 0.0;
            rhs[0]  = m_left_value;
            ...
            // std::cout << "m_left == spline::first_deriv" << std::endl;
            // std::cout << "m_leff_value:" << m_left_value << std::endl;
        ...
        if (m_right == spline::second_deriv) {
            // std::cout << "m_right == spline::second_deriv" << std::endl;
            // std::cout << "m_right_value:" << m_right_value << std::endl;
            // 2*b[n-1] = f''
            A(n - 1, n - 1) = 2.0;
            A(n - 1, n - 2) = 0.0;
            ...
            // std::cout << "m_right == spline::first_deriv" << std::endl;
            // std::cout << "m_right_value:" << m_right_value << std::endl;
        ...
        for (int i = 0; i < n - 1; i++) {
            ...
            m_c[i] =
                (y[i + 1] - y[i]) / (x[i + 1] - x[i]) - 1.0 / 3.0 * (2.0 * m_b[i] + m_b[i + 1]) * (x[i + 1] - x[i]);
        }
    }
