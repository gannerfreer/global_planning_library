...
enum ReedsSheppPathSegmentType:uint8 {RS_NOP=0,
                                      RS_LEFT=1,
                                      RS_STRAIGHT=2,
                                      RS_RIGHT=3
                                     };//枚举路段类型
 ...
 * @return 返回说明：无
 */
  bool PlanRSPath(const Point start,
                  const Point end,
                  Path &rs_path,
                  PlanRule plan_rule,
                  vehicle_param m_vehicle_prarm);
