...
class WaitPointGenerator {
  private:
    ...
    vector<arc_sample_point> SampleCandiPoints(GlobalPlanning::CollisonCheck& collision_checker, double max_steering, double min_steering, const GlobalPlanning::Point& start_point);
