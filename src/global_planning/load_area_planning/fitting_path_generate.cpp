...
std::vector<GlobalPlanning::Point> FittingPathGenerator::SamplePathSegment(const GlobalPlanning::Path& target_path, const GlobalPlanning::Point& load_point, int flag) {
