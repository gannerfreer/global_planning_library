...
class CRvizPath {
  ...
  public:
    ...
    // const double x_o_ = -1171.654151;//玖智
    // const double y_o_ = 6205.765819;//

    // const double x_o_ = -321737.4857;     // 舒兰
    // const double y_o_ = 534463.584699999; // 舒兰


    const double x_o_ = 0; // 鲁南
    const double y_o_ = 0; // 鲁南

    // const double x_o_ = -205293.9231; // 致富
    // const double y_o_ = 7973.5012;    // 致富
};
} // namespace rviz_path
